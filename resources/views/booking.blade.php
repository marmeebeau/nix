...
<body class="">
        ...
        <form action="" id="bookingForm">
            ...
            <div class="columns">
                <div class="fields">
                    ...
                    <div class="field">
                        <select name="guests" id="guests">
                            <option value="" disabled selected>Re-estimated Guests</option>
                ...
                <div class="fields group">
                    ...
                    <ul class="options" id="motifCheckboxes">
                        <li class="option">
    ...
    <script>
        const checkboxes = document.querySelectorAll('#motifCheckboxes input[type="checkbox"]');

        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', () => {
                const checkedCheckboxes = Array.from(checkboxes).filter(i => i.checked);
                if (checkedCheckboxes.length > 3) {
                    alert('You can only select up to 3 motifs.');
